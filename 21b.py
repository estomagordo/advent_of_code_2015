        ...
        for sword in swords:
            ...
            for armour in armours:
                if sword[0] + armour[0] > gold:
                    break
                if not fight([100, sword[1], armour[2]], copy(boss)):
                    highest_loss = max(highest_loss, sword[0] + armour[0])
                for ring in rings:
                    if sword[0] + armour[0] + ring[0] > gold:
                        continue
                    if not fight([100, sword[1] + ring[1], armour[2] + ring[2]], copy(boss)):
                        highest_loss = max(highest_loss, sword[0] + armour[0] + ring[0])
                for ringpair in combinations(rings, 2):
                    if sword[0] + armour[0] + ringpair[0][0] + ringpair[1][0] > gold:
                        continue
                    if not fight([100, sword[1] + ringpair[0][1] + ringpair[1][1], armour[2] + ringpair[0][2] + ringpair[1][2]], copy(boss)):
                        highest_loss = max(highest_loss, sword[0] + armour[0] + ringpair[0][0] + ringpair[1][0])
